...
type ModelsResponse struct {
	// List of models
	Data []ModelsResponseData `json:"data,required"`
	// Object type
...
// Returns the unmodified JSON received from the API
func (r ModelsResponseData) RawJSON() string { return r.JSON.raw }
func (r *ModelsResponseData) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
