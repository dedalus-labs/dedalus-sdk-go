...
type Annotation struct {
	...
	Type AnnotationType `json:"type" api:"required"`
	// A URL citation when using web search.
	URLCitation URLCitation    `json:"url_citation" api:"required"`
...
type ChatCompletion struct {
	...
	// than 1.
	Choices []Choice `json:"choices" api:"required"`
	// The Unix timestamp (in seconds) of when the chat completion was created.
	Created int64 `json:"created" api:"required"`
	// The model used for the chat completion.
	Model string `json:"model" api:"required"`
	// The object type, which is always `chat.completion`.
	Object ChatCompletionObject `json:"object" api:"required"`
	...
	MCPServerErrors map[string]interface{} `json:"mcp_server_errors" api:"nullable"`
	...
	ToolsExecuted []string `json:"tools_executed" api:"nullable"`
...
type ChatCompletionAssistantMessageParam struct {
	...
	Role param.Field[ChatCompletionAssistantMessageParamRole] `json:"role" api:"required"`
...
type ChatCompletionAssistantMessageParamContentChatCompletionRequestAssistantMessageContentArrayItem struct {
	...
	Type param.Field[ChatCompletionAssistantMessageParamContentChatCompletionRequestAssistantMessageContentArrayType] `json:"type" api:"required"`
...
type ChatCompletionAssistantMessageParamFunctionCall struct {
	...
	Arguments param.Field[string] `json:"arguments" api:"required"`
...
type ChatCompletionAssistantMessageParamToolCall struct {
	...
	Type   param.Field[ChatCompletionAssistantMessageParamToolCallsType] `json:"type" api:"required"`
...
type ChatCompletionAssistantMessageParamToolCallsChatCompletionMessageToolCallInput struct {
	...
	ID param.Field[string] `json:"id" api:"required"`
	// The function that the model called.
	Function param.Field[ChoiceDeltaToolCallFunctionParam] `json:"function" api:"required"`
	// The type of the tool. Currently, only `function` is supported.
	Type param.Field[ChatCompletionAssistantMessageParamToolCallsChatCompletionMessageToolCallInputType] `json:"type" api:"required"`
	// Opaque signature for thought continuity in multi-turn tool use (Google-specific,
	// base64 encoded)
	ThoughtSignature param.Field[string] `json:"thought_signature"`
}
...
type ChatCompletionAssistantMessageParamToolCallsChatCompletionMessageCustomToolCallInput struct {
	...
	Custom param.Field[ChatCompletionAssistantMessageParamToolCallsChatCompletionMessageCustomToolCallInputCustom] `json:"custom" api:"required"`
	// The type of the tool. Always `custom`.
	Type param.Field[ChatCompletionAssistantMessageParamToolCallsChatCompletionMessageCustomToolCallInputType] `json:"type" api:"required"`
}
...
type ChatCompletionAssistantMessageParamToolCallsChatCompletionMessageCustomToolCallInputCustom struct {
	...
	Input param.Field[string] `json:"input" api:"required"`
...
type ChatCompletionChunk struct {
	...
	Object ChatCompletionChunkObject `json:"object" api:"required"`
	// Specifies the processing type used for serving the request.
	//
	//   - If set to 'auto', then the request will be processed with the service tier
	//     configured in the Project settings. Unless otherwise configured, the Project
...
type ChatCompletionChunkChoice struct {
	...
	Delta ChoiceDelta `json:"delta" api:"required"`
	...
	// function.
	FinishReason ChatCompletionChunkChoicesFinishReason `json:"finish_reason" api:"required"`
	...
	Logprobs ChatCompletionChunkChoicesLogprobs `json:"logprobs" api:"nullable"`
...
type ChatCompletionContentPartAudioParam struct {
	...
	InputAudio param.Field[ChatCompletionContentPartAudioParamInputAudio] `json:"input_audio" api:"required"`
	// The type of the content part. Always `input_audio`.
	Type param.Field[ChatCompletionContentPartAudioParamType] `json:"type" api:"required"`
}
...
type ChatCompletionContentPartAudioParamInputAudio struct {
	...
	Format param.Field[ChatCompletionContentPartAudioParamInputAudioFormat] `json:"format" api:"required"`
}
...
type ChatCompletionContentPartFileParam struct {
	...
	File param.Field[ChatCompletionContentPartFileParamFile] `json:"file" api:"required"`
	// The type of the content part. Always `file`.
	Type param.Field[ChatCompletionContentPartFileParamType] `json:"type" api:"required"`
}
...
type ChatCompletionContentPartImageParam struct {
	...
	ImageURL param.Field[ChatCompletionContentPartImageParamImageURL] `json:"image_url" api:"required"`
	// The type of the content part.
	Type param.Field[ChatCompletionContentPartImageParamType] `json:"type" api:"required"`
}
...
type ChatCompletionContentPartRefusalParam struct {
	// The refusal message generated by the model.
	Refusal param.Field[string] `json:"refusal" api:"required"`
	// The type of the content part.
	Type param.Field[ChatCompletionContentPartRefusalParamType] `json:"type" api:"required"`
}
...
type ChatCompletionContentPartTextParam struct {
	...
	// The type of the content part.
	Type param.Field[ChatCompletionContentPartTextParamType] `json:"type" api:"required"`
}
...
type ChatCompletionDeveloperMessageParam struct {
	...
	Content param.Field[ChatCompletionDeveloperMessageParamContentUnion] `json:"content" api:"required"`
	// The role of the messages author, in this case `developer`.
	Role param.Field[ChatCompletionDeveloperMessageParamRole] `json:"role" api:"required"`
	// An optional name for the participant. Provides the model information to
	// differentiate between participants of the same role.
	Name param.Field[string] `json:"name"`
}
...
type ChatCompletionFunctionMessageParam struct {
	...
	Role param.Field[ChatCompletionFunctionMessageParamRole] `json:"role" api:"required"`
}
...
type ChatCompletionMessage struct {
	...
	// The refusal message generated by the model.
	Refusal string `json:"refusal" api:"required,nullable"`
...
type ChatCompletionMessageToolCall struct {
	...
	ID string `json:"id" api:"required"`
	// The type of the tool. Currently, only `function` is supported.
	Type ChatCompletionMessageToolCallsType `json:"type" api:"required"`
	// The custom tool that the model called.
	...
	// Opaque signature for thought continuity in multi-turn tool use (Google-specific,
	// base64 encoded)
	ThoughtSignature string                            `json:"thought_signature" api:"nullable"`
...
type ChatCompletionMessageCustomToolCall struct {
	...
	ID string `json:"id" api:"required"`
	// The custom tool that the model called.
	Custom Custom `json:"custom" api:"required"`
	// The type of the tool. Always `custom`.
	Type ChatCompletionMessageCustomToolCallType `json:"type" api:"required"`
...
type ChatCompletionSystemMessageParam struct {
	...
	Content param.Field[ChatCompletionSystemMessageParamContentUnion] `json:"content" api:"required"`
	// The role of the messages author, in this case `system`.
	Role param.Field[ChatCompletionSystemMessageParamRole] `json:"role" api:"required"`
	// An optional name for the participant. Provides the model information to
	// differentiate between participants of the same role.
	Name param.Field[string] `json:"name"`
}
...
type ChatCompletionTokenLogprob struct {
	...
	Bytes []int64 `json:"bytes" api:"required,nullable"`
	...
	TopLogprobs []TopLogprob                   `json:"top_logprobs" api:"required"`
...
type ChatCompletionToolMessageParam struct {
	...
	Content param.Field[ChatCompletionToolMessageParamContentUnion] `json:"content" api:"required"`
	// The role of the messages author, in this case `tool`.
	Role param.Field[ChatCompletionToolMessageParamRole] `json:"role" api:"required"`
	// Tool call that this message is responding to.
	ToolCallID param.Field[string] `json:"tool_call_id" api:"required"`
}
...
type ChatCompletionToolParam struct {
	...
	Function param.Field[shared.FunctionDefinitionParam] `json:"function" api:"required"`
	// The type of the tool. Currently, only `function` is supported.
	Type param.Field[ChatCompletionToolParamType] `json:"type" api:"required"`
}
...
type ChatCompletionUserMessageParam struct {
	...
	Content param.Field[ChatCompletionUserMessageParamContentUnion] `json:"content" api:"required"`
	// The role of the messages author, in this case `user`.
	Role param.Field[ChatCompletionUserMessageParamRole] `json:"role" api:"required"`
	// An optional name for the participant. Provides the model information to
	// differentiate between participants of the same role.
	Name param.Field[string] `json:"name"`
}
...
type ChatCompletionUserMessageParamContentChatCompletionRequestUserMessageContentArrayItem struct {
	// The type of the content part.
	Type       param.Field[ChatCompletionUserMessageParamContentChatCompletionRequestUserMessageContentArrayType] `json:"type" api:"required"`
...
type Choice struct {
	...
	// model called a tool, or `function_call` (deprecated) if the model called a
	// function.
	FinishReason ChoiceFinishReason `json:"finish_reason" api:"nullable"`
	// Log probability information for the choice.
	Logprobs ChoiceLogprobs `json:"logprobs" api:"nullable"`
...
type ChoiceLogprobs struct {
	// A list of message content tokens with log probability information.
	Content []ChatCompletionTokenLogprob `json:"content" api:"nullable"`
	// A list of message refusal tokens with log probability information.
	Refusal []ChatCompletionTokenLogprob `json:"refusal" api:"nullable"`
...
type PredictionContentParam struct {
	...
	Content param.Field[PredictionContentContentUnionParam] `json:"content" api:"required"`
	// The type of the predicted content you want to provide. This type is currently
	// always `content`.
	Type param.Field[PredictionContentType] `json:"type" api:"required"`
}
...
type ThinkingConfigDisabledParam struct {
	Type param.Field[ThinkingConfigDisabledType] `json:"type" api:"required"`
}
...
type ThinkingConfigEnabledParam struct {
	...
	// for details.
	BudgetTokens param.Field[int64]                     `json:"budget_tokens" api:"required"`
	Type         param.Field[ThinkingConfigEnabledType] `json:"type" api:"required"`
}
...
type ToolChoiceAnyParam struct {
	Type param.Field[ToolChoiceAnyType] `json:"type" api:"required"`
...
type ToolChoiceAutoParam struct {
	Type param.Field[ToolChoiceAutoType] `json:"type" api:"required"`
	// Whether to disable parallel tool use.
	//
...
type ToolChoiceNoneParam struct {
	Type param.Field[ToolChoiceNoneType] `json:"type" api:"required"`
}
...
type ToolChoiceToolParam struct {
	...
	Name param.Field[string]             `json:"name" api:"required"`
	Type param.Field[ToolChoiceToolType] `json:"type" api:"required"`
	// Whether to disable parallel tool use.
	//
	// Defaults to `false`. If set to `true`, the model will output exactly one tool
	// use.
...
type ChatCompletionNewParams struct {
	...
	Model param.Field[ChatCompletionNewParamsModelUnion] `json:"model" api:"required"`
...
type ChatCompletionNewParamsMessage struct {
	// The role of the messages author, in this case `developer`.
	Role param.Field[ChatCompletionNewParamsMessagesRole] `json:"role" api:"required"`
	// Data about a previous audio response from the model.
	// [Learn more](https://platform.openai.com/docs/guides/audio).
	//
	// Fields:
...
type ChatCompletionNewParamsResponseFormat struct {
	...
	Type       param.Field[ChatCompletionNewParamsResponseFormatType] `json:"type" api:"required"`
...
type ChatCompletionNewParamsSafetySetting struct {
	...
	Category param.Field[ChatCompletionNewParamsSafetySettingsCategory] `json:"category" api:"required"`
	// Required. Controls the probability threshold at which harm is blocked.
	Threshold param.Field[ChatCompletionNewParamsSafetySettingsThreshold] `json:"threshold" api:"required"`
}
...
type ChatCompletionNewParamsThinking struct {
	Type param.Field[ChatCompletionNewParamsThinkingType] `json:"type" api:"required"`
	// Determines how many tokens Claude can use for its internal reasoning process.
	// Larger budgets can enable more thorough analysis for complex problems, improving
	// response quality.
	//
...
type ChatCompletionNewParamsToolChoice struct {
	Type param.Field[ChatCompletionNewParamsToolChoiceType] `json:"type" api:"required"`
	// Whether to disable parallel tool use.
	//
	// Defaults to `false`. If set to `true`, the model will output at most one tool
	// use.
...
type ChatCompletionNewParamsTool struct {
	// The type of the tool. Currently, only `function` is supported.
	Type   param.Field[ChatCompletionNewParamsToolsType] `json:"type" api:"required"`
	Custom param.Field[interface{}]                      `json:"custom"`
	// Schema for FunctionObject.
	//
	// Fields:
...
type ChatCompletionNewParamsToolsCustomToolChatCompletions struct {
	...
	Custom param.Field[ChatCompletionNewParamsToolsCustomToolChatCompletionsCustom] `json:"custom" api:"required"`
	// The type of the custom tool. Always `custom`.
	Type param.Field[ChatCompletionNewParamsToolsCustomToolChatCompletionsType] `json:"type" api:"required"`
}
...
type ChatCompletionNewParamsToolsCustomToolChatCompletionsCustomFormat struct {
	...
	Type    param.Field[ChatCompletionNewParamsToolsCustomToolChatCompletionsCustomFormatType] `json:"type" api:"required"`
...
type ChatCompletionNewParamsToolsCustomToolChatCompletionsCustomFormatTextFormat struct {
	// Unconstrained text format. Always `text`.
	Type param.Field[ChatCompletionNewParamsToolsCustomToolChatCompletionsCustomFormatTextFormatType] `json:"type" api:"required"`
}
...
type ChatCompletionNewParamsToolsCustomToolChatCompletionsCustomFormatGrammarFormat struct {
	// Your chosen grammar.
	Grammar param.Field[ChatCompletionNewParamsToolsCustomToolChatCompletionsCustomFormatGrammarFormatGrammar] `json:"grammar" api:"required"`
	// Grammar format. Always `grammar`.
	Type param.Field[ChatCompletionNewParamsToolsCustomToolChatCompletionsCustomFormatGrammarFormatType] `json:"type" api:"required"`
}
...
type ChatCompletionNewParamsToolsCustomToolChatCompletionsCustomFormatGrammarFormatGrammar struct {
	...
	Definition param.Field[string] `json:"definition" api:"required"`
	// The syntax of the grammar definition. One of `lark` or `regex`.
	Syntax param.Field[ChatCompletionNewParamsToolsCustomToolChatCompletionsCustomFormatGrammarFormatGrammarSyntax] `json:"syntax" api:"required"`
}
