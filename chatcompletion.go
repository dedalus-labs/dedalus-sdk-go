...
// [ChatCompletionAssistantMessageParamContentArray].
type ChatCompletionAssistantMessageParamContentUnion interface {
	ImplementsChatCompletionAssistantMessageParamContentUnion()
}

type ChatCompletionAssistantMessageParamContentArray []ChatCompletionAssistantMessageParamContentArrayUnionItem

func (r ChatCompletionAssistantMessageParamContentArray) ImplementsChatCompletionAssistantMessageParamContentUnion() {
}
...
// - text (required): str
type ChatCompletionAssistantMessageParamContentArrayItem struct {
	// The type of the content part.
	Type param.Field[ChatCompletionAssistantMessageParamContentArrayType] `json:"type,required"`
...
func (r ChatCompletionAssistantMessageParamContentArrayItem) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

func (r ChatCompletionAssistantMessageParamContentArrayItem) implementsChatCompletionAssistantMessageParamContentArrayUnionItem() {
}
...
// [ChatCompletionAssistantMessageParamContentArrayItem].
type ChatCompletionAssistantMessageParamContentArrayUnionItem interface {
	implementsChatCompletionAssistantMessageParamContentArrayUnionItem()
}

// The type of the content part.
type ChatCompletionAssistantMessageParamContentArrayType string

const (
	ChatCompletionAssistantMessageParamContentArrayTypeText    ChatCompletionAssistantMessageParamContentArrayType = "text"
	ChatCompletionAssistantMessageParamContentArrayTypeRefusal ChatCompletionAssistantMessageParamContentArrayType = "refusal"
)

func (r ChatCompletionAssistantMessageParamContentArrayType) IsKnown() bool {
	switch r {
	case ChatCompletionAssistantMessageParamContentArrayTypeText, ChatCompletionAssistantMessageParamContentArrayTypeRefusal:
		return true
	}
	return false
}
...
type ChatCompletionAssistantMessageParamToolCall struct {
	...
	Custom   param.Field[CustomParam] `json:"custom"`
...
func (r ChatCompletionContentPartAudioParam) implementsChatCompletionUserMessageParamContentArrayUnionItem() {
}
...
func (r ChatCompletionContentPartFileParam) implementsChatCompletionUserMessageParamContentArrayUnionItem() {
}
...
func (r ChatCompletionContentPartImageParam) implementsChatCompletionUserMessageParamContentArrayUnionItem() {
}
...
func (r ChatCompletionContentPartRefusalParam) implementsChatCompletionAssistantMessageParamContentArrayUnionItem() {
}
...
func (r ChatCompletionContentPartTextParam) implementsChatCompletionAssistantMessageParamContentArrayUnionItem() {
}

func (r ChatCompletionContentPartTextParam) implementsChatCompletionUserMessageParamContentArrayUnionItem() {
}
...
//
// Satisfied by [shared.UnionString],
// [ChatCompletionDeveloperMessageParamContentArray].
type ChatCompletionDeveloperMessageParamContentUnion interface {
	ImplementsChatCompletionDeveloperMessageParamContentUnion()
}

type ChatCompletionDeveloperMessageParamContentArray []ChatCompletionContentPartTextParam

func (r ChatCompletionDeveloperMessageParamContentArray) ImplementsChatCompletionDeveloperMessageParamContentUnion() {
}
...
type ChatCompletionMessageCustomToolCallParam struct {
	...
	ID param.Field[string] `json:"id,required"`
	// The custom tool that the model called.
	Custom param.Field[CustomParam] `json:"custom,required"`
	// The type of the tool. Always `custom`.
	Type param.Field[ChatCompletionMessageCustomToolCallType] `json:"type,required"`
}
...
func (r ChatCompletionMessageCustomToolCallParam) implementsChatCompletionAssistantMessageParamToolCallsUnion() {
}
...
//
// Satisfied by [shared.UnionString],
// [ChatCompletionSystemMessageParamContentArray].
type ChatCompletionSystemMessageParamContentUnion interface {
	ImplementsChatCompletionSystemMessageParamContentUnion()
}

type ChatCompletionSystemMessageParamContentArray []ChatCompletionContentPartTextParam

func (r ChatCompletionSystemMessageParamContentArray) ImplementsChatCompletionSystemMessageParamContentUnion() {
}
...
// The contents of the tool message.
//
// Satisfied by [shared.UnionString], [ChatCompletionToolMessageParamContentArray].
type ChatCompletionToolMessageParamContentUnion interface {
	ImplementsChatCompletionToolMessageParamContentUnion()
}

type ChatCompletionToolMessageParamContentArray []ChatCompletionContentPartTextParam

func (r ChatCompletionToolMessageParamContentArray) ImplementsChatCompletionToolMessageParamContentUnion() {
}
...
// The contents of the user message.
//
// Satisfied by [shared.UnionString], [ChatCompletionUserMessageParamContentArray].
type ChatCompletionUserMessageParamContentUnion interface {
	ImplementsChatCompletionUserMessageParamContentUnion()
}

type ChatCompletionUserMessageParamContentArray []ChatCompletionUserMessageParamContentArrayUnionItem

func (r ChatCompletionUserMessageParamContentArray) ImplementsChatCompletionUserMessageParamContentUnion() {
}
...
// - type (required): Literal["text"]
// - text (required): str
type ChatCompletionUserMessageParamContentArrayItem struct {
	// The type of the content part.
	Type       param.Field[ChatCompletionUserMessageParamContentArrayType] `json:"type,required"`
...
func (r ChatCompletionUserMessageParamContentArrayItem) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

func (r ChatCompletionUserMessageParamContentArrayItem) implementsChatCompletionUserMessageParamContentArrayUnionItem() {
}
...
// [ChatCompletionUserMessageParamContentArrayItem].
type ChatCompletionUserMessageParamContentArrayUnionItem interface {
	implementsChatCompletionUserMessageParamContentArrayUnionItem()
}

// The type of the content part.
type ChatCompletionUserMessageParamContentArrayType string

const (
	ChatCompletionUserMessageParamContentArrayTypeText       ChatCompletionUserMessageParamContentArrayType = "text"
	ChatCompletionUserMessageParamContentArrayTypeImageURL   ChatCompletionUserMessageParamContentArrayType = "image_url"
	ChatCompletionUserMessageParamContentArrayTypeInputAudio ChatCompletionUserMessageParamContentArrayType = "input_audio"
	ChatCompletionUserMessageParamContentArrayTypeFile       ChatCompletionUserMessageParamContentArrayType = "file"
)

func (r ChatCompletionUserMessageParamContentArrayType) IsKnown() bool {
	switch r {
	case ChatCompletionUserMessageParamContentArrayTypeText, ChatCompletionUserMessageParamContentArrayTypeImageURL, ChatCompletionUserMessageParamContentArrayTypeInputAudio, ChatCompletionUserMessageParamContentArrayTypeFile:
		return true
	}
	return false
}
...
func (r CustomParam) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}
...
// returned much more quickly.
//
// Satisfied by [shared.UnionString], [PredictionContentContentArrayParam].
type PredictionContentContentUnionParam interface {
	ImplementsPredictionContentContentUnionParam()
}

type PredictionContentContentArrayParam []ChatCompletionContentPartTextParam

func (r PredictionContentContentArrayParam) ImplementsPredictionContentContentUnionParam() {}
