...
type CompletionRequestModelUnionParam struct {
	...
	OfModelList    []CompletionRequestModelModelListItemUnionParam `json:",omitzero,inline"`
	paramUnion
}

func (u CompletionRequestModelUnionParam) MarshalJSON() ([]byte, error) {
	return param.MarshalUnion(u, u.OfModelID, u.OfDedalusModel, u.OfModelList)
}
...
func (u *CompletionRequestModelUnionParam) asAny() any {
	...
	} else if !param.IsOmitted(u.OfModelList) {
		return &u.OfModelList
	}
	return nil
}
...
//
// Use [param.IsOmitted] to confirm if a field is set.
type CompletionRequestModelModelListItemUnionParam struct {
	OfModelID      param.Opt[string] `json:",omitzero,inline"`
	OfDedalusModel *ModelParam       `json:",omitzero,inline"`
	paramUnion
}

func (u CompletionRequestModelModelListItemUnionParam) MarshalJSON() ([]byte, error) {
	return param.MarshalUnion(u, u.OfModelID, u.OfDedalusModel)
}
func (u *CompletionRequestModelModelListItemUnionParam) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, u)
}

func (u *CompletionRequestModelModelListItemUnionParam) asAny() any {
	if !param.IsOmitted(u.OfModelID) {
		return &u.OfModelID.Value
	} else if !param.IsOmitted(u.OfDedalusModel) {
		return u.OfDedalusModel
